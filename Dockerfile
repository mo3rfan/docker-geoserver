...
RUN wget http://maven.geo-solutions.it/org/hibernatespatial/hibernate-spatial-postgis/1.1.3.2/hibernate-spatial-postgis-1.1.3.2.jar -O ${CATALINA_BASE}/webapps/geoserver/WEB-INF/lib/hibernate-spatial-postgis-1.1.3.2.jar

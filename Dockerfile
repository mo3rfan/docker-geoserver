...
RUN wget http://www.hibernatespatial.org/repository/org/hibernatespatial/hibernate-spatial-postgis/1.1.1/hibernate-spatial-postgis-1.1.1.jar -O ${CATALINA_BASE}/webapps/geoserver/WEB-INF/lib/hibernate-spatial-postgis-1.1.1.jar

RUN  wget https://repo1.maven.org/maven2/org/postgis/postgis-jdbc/1.3.3/postgis-jdbc-1.3.3.jar -O ${CATALINA_BASE}/webapps/geoserver/WEB-INF/lib/postgis-jdbc-1.3.3.jar
